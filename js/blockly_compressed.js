...
if(localStorage.backgroundpicture){
	...
	bgp = "https://s1.ax1x.com/2020/04/26/Jcajkd.png";
}
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;", "position: absolute;", "display: block;",'background-image: url("'+bgp+'");','background-size:cover;','background-position: center center;', "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 99999;", "}", ".injectionDiv {", "height: 100%;", "position: relative;", "overflow: hidden;", "touch-action: none;", "}", ".blocklyNonSelectable {", "user-select: none;", "-ms-user-select: none;", "-webkit-user-select: none;", "}", ".blocklyWsDragSurface {", "display: none;", "position: absolute;", "top: 0;",
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
    ...
    if (c) this.warningTextDb_[c] && (clearTimeout(this.warningTextDb_[c]), delete this.warningTextDb_[c]);
        ...
        for (var d in this.warningTextDb_) clearTimeout(this.warningTextDb_[d]), delete this.warningTextDb_[d]; if (this.workspace.isDragging()) {
        var e = this;
...
Blockly.Variables.promptName = function(a, b, c) {
    Blockly.prompt(a, b, function(a) {
        a && (a = a.replace(/[\s ]+/g, " ").trim(), a == Blockly.Msg.RENAME_VARIABLE || a == Blockly.Msg.NEW_VARIABLE) && (a = null);
        c(a)
    })
};
...
Blockly.Generator.prototype.provideFunction_ = function(a, b) {
    if (!this.definitions_[a]) {
        ...
        for (var d; d != b;) d = b, b = b.replace(/^(( {2})*) {2}/gm, "$1");
...
Blockly.Toolbox.prototype.handleBeforeTreeSelected_ = function(a) {
    ...
    this.lastCategory_ && (this.lastCategory_.getRowElement().style.backgroundImage = "");
    if (a) {
        var b = a.hexColour || "#57e";
        //a.getRowElement().style.backgroundColor = b;
		a.getRowElement().style.backgroundImage = 'linear-gradient(to right,'+b+'FF,#E4E4E4FF'+')'
        this.addColour_(a)
    }
    return !0
};
